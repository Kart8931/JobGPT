...
import { useAuth } from '../../auth/hooks/useAuth.js' // ✅ useAuth hook import kiya

const Home = () => {
    // ✅ user aur handleLogout yahan se mil jayenge
    ...
    return (
        <div className='home-page'>
            ...
            <header className='page-header'>
                ...
                {/* ✅ Logout button ab style sheet se handle hoga */}
            ...
            <div className='interview-card'>
                <div className='interview-card__body'>
                    ...
                    {/* Right Panel - Profile Section Updated */}
                    <div className='panel panel--right'>
                        <div className='panel__header'>
                            <span className='panel__icon'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" /></svg>
                            </span>
                            {/* ✅ Logged in user ka naam yahan dikhega */}
                            <h2>{user ? `${user.username}` : 'Your Profile'}</h2>
                        </div>
                        ...
                        <div className='upload-section'>
                            ...
                            {selectedFileName && (
                                <div style={{ marginTop: '10px', color: '#ff2d78', fontSize: '14px', fontWeight: 'bold' }}>
